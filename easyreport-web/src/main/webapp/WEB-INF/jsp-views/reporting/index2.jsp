...
<body id="layout" class="easyui-layout" style="text-align: left">
	...
	<div id="reportingPower">
		<table cellpadding="0" class="formStyle" cellspacing="0" style="width: 99%; margin: 1px 2px 1px 8px">
			<tr>
				<td class="blueside" width="30%">可选用户</td>
				<td class="blueside" width="10%">操作</td>
				<td class="blueside" width="60%">已选用户</td>
			</tr>
			<tr id="reportingPowerTr">
				<td style="vertical-align: top; text-align: left;">
					<ul id="reportingPowerTree"></ul> <input id="reportingPowerReportId" name="reportId" type="hidden" /><input id="reportingPowerUserIds"
					type="hidden" />
				</td>
				<td style="vertical-align: middle; text-align: center;"><a id="reportingPowerBtn" href="#" class="easyui-linkbutton"
					data-options="iconCls:'icon-add'" onclick="Reporting.setPrivilege()">添加</a></td>
				<td style="vertical-align: top; text-align: left;">
					<div id="reportingPowerGrid"></div>
				</td>
			</tr>
		</table>
	</div>
	<div id="reportingContacts">
		<table cellpadding="0" class="formStyle" cellspacing="0" style="width: 99%; margin: 1px 2px 1px 8px">
			<tr>
				<td class="blueside" width="30%">可选联系人</td>
				<td class="blueside" width="10%">操作</td>
				<td class="blueside" width="60%">已选联系人</td>
			</tr>
			<tr id="reportingContactsTr">
				<td style="vertical-align: top; text-align: left;">
					<ul id="reportingContactsTree"></ul> <input id="reportingContactsReportId" name="reportId" type="hidden" /><input id="reportingContactsIds"
					type="hidden" /><input type="hidden" id="hiddenPid"/>
				</td>
				<td style="vertical-align: middle; text-align: center;"><a id="reportingContactsBtn" href="#" class="easyui-linkbutton"
					data-options="iconCls:'icon-add'" onclick="Reporting.addContacts()">添加</a></td>
				<td style="vertical-align: top; text-align: left;">
					<div id="reportingContactsGrid"></div>
				</td>
			</tr>
		</table>
	</div>
	<div id="reportingProperties">
		<table cellpadding="0" class="formStyle" cellspacing="0" style="width: 99%; margin: 1px 2px 1px 8px">
			...
			<tr>
				...
				<td class="text_r blueside">布局形式:</td>
				<td><label id="reportingProp_layoutType" /></td>
				<td class="text_r blueside">显示几天数据:</td>
	...
	<div id="reportingTreeCtxMenu" class="easyui-menu" data-options="onClick:Reporting.treeContextMenu" style="width: 220px;">
		...
		<div id="m-privilage" data-options="name:'privilage',iconCls:'icon-privilage'">权限设置</div>
		<div id="m-contacts" data-options="name:'contacts',iconCls:'icon-contacts'">联系人设置</div>
		...
		<div id="m-chown" data-options="name:'chown',iconCls:'icon-edit'">修改负责人</div>
