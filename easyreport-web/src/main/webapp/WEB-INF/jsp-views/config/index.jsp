...
<script type="text/javascript" src="<%=request.getContextPath()%>/static/report/js/configDict.js?v=<%=Math.random()%>"></script>
</head>
		...
		<form id="configDictForm" method="post" novalidate>
			<table cellpadding="0" class="formStyle" cellspacing="0" style="width: 99%;">
				...
				<tr>
					...
					<td><textarea name="comment" style="width: 99%; height: 80px;"></textarea><input id="configDictPid" type="hidden" name="pid" value="0" />
						<input id="configDictId" type="hidden" name="id" value="0" /> <input id="configDictAction" type="hidden" name="action" /></td>
				</tr>
			</table>
		</form>
	</div>
