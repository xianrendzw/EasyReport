		...
		<form id="templateFrom" method="post">
			<table cellpadding="0" class="formStyle" cellspacing="0" style="width: 99%;">
				...
				<tr style="height: 40px;">
					<td style="text-align: left; vertical-align: middle; white-space: normal;">${formHtmlText}<input id="isRowSpan" type="checkbox" name="isRowSpan"
						checked="checked" />是否合并相同行 <a id="btnGenarate" href="#" class="easyui-linkbutton" style="vertical-align: bottom" data-options="iconCls:'icon-ok'">生成报表</a></td>
