	...
	<div id="datasourceDlg" style="width: 500px; height: 300px; padding: 10px 20px";>
		<form id="datasourceForm" method="post">
			<table cellpadding="0" class="formStyle" cellpadding="5" cellspacing="5" style="width: 99%;">
				...
				<tr>
					<td class="text_r blueside" style="font-size: 15px">用户名:</td>
					<td><input id="configUser" name="user" class="easyui-validatebox" required="true" style="width: 300px;" /></td>
				</tr>
				<tr>
					<td class="text_r blueside" style="font-size: 15px">密码:</td>
					<td><input id="configPassword" name="password" class="easyui-validatebox" required="true" style="width: 300px;" /> <input id="datasourceId"
