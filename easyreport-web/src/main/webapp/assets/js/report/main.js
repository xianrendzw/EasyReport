...
var PreviewMainMVC = {
    ...
    View: {
        ...
        initData: function () {
            ...
            PreviewMainMVC.Controller.updateTab( jQuery.i18n.prop('main.table'), tableUrl, TableReport.init);
            PreviewMainMVC.Controller.updateTab( jQuery.i18n.prop('main.chart'), chartUrl, ChartReport.init);
        }
    },
    Controller: {
