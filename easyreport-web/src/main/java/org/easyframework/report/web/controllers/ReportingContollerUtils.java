...
@Service
public class ReportingContollerUtils {
	private static ReportingService reportingService;
	private static ReportingGenerationService generationService;

	@Autowired
	public ReportingContollerUtils(ReportingService reportingService, ReportingGenerationService generationService) {
		ReportingContollerUtils.reportingService = reportingService;
		ReportingContollerUtils.generationService = generationService;
	}
